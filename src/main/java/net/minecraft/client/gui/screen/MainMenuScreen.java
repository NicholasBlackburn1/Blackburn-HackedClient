...
public class MainMenuScreen extends Screen {
   ...
   private static final ResourceLocation MINECRAFT_TITLE_TEXTURES = new ResourceLocation("textures/gui/title/title.png");
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      int i = 274;
      int ypos = this.width / 2 - 137;
      int xpos = 30;
      int title_width = 788;
      int title_hight = 78;
      int title_fullness = 78;
      ...
      if ((l & -67108864) != 0) {
         ...
         GlStateManager.color4f(1.0F, 1.0F, 1.0F, f1);
            ...
            //            y       x                
            this.blit(ypos+ 80, xpos, 0, 0, 72*2, 18*2, 72*2, 18*2);
         ...
         String s = "Minecraft " + "1.14.4-Blackburn";
         if (this.minecraft.isDemo()) {
            s = s + " Demo";
         } else {
         ...
         this.drawString(this.font, "Copyright Nicholas Blackburn! UwU", this.widthCopyrightRest, this.height - 10, 16777215 | l);
