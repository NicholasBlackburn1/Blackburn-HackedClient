...
public abstract class SlotGui extends FocusableGui implements IRenderable {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      if (this.visible) {
         ...
         bufferbuilder.pos((double)this.x0, (double)this.y1, 0.0D).tex((double)((float)this.x0 / 32.0F), (double)((float)(this.y1 + (int)this.yo) / 32.0F)).color(32, 32, 32, 255).endVertex();
         bufferbuilder.pos((double)this.x1, (double)this.y1, 0.0D).tex((double)((float)this.x1 / 32.0F), (double)((float)(this.y1 + (int)this.yo) / 32.0F)).color(32, 32, 32, 255).endVertex();
         bufferbuilder.pos((double)this.x1, (double)this.y0, 0.0D).tex((double)((float)this.x1 / 32.0F), (double)((float)(this.y0 + (int)this.yo) / 32.0F)).color(32, 32, 32, 255).endVertex();
         bufferbuilder.pos((double)this.x0, (double)this.y0, 0.0D).tex((double)((float)this.x0 / 32.0F), (double)((float)(this.y0 + (int)this.yo) / 32.0F)).color(32, 32, 32, 255).endVertex();
         tessellator.draw();
