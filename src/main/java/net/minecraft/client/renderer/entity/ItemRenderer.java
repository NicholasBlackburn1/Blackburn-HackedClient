...
public class ItemRenderer extends EntityRenderer<ItemEntity> {
   ...
   public void doRender(ItemEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      float f = ibakedmodel.getItemCameraTransforms().ground.scale.getX();
      float f1 = ibakedmodel.getItemCameraTransforms().ground.scale.getY();
      float f2 = ibakedmodel.getItemCameraTransforms().ground.scale.getZ();
