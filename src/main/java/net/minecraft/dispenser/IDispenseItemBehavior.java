      ...
      DispenserBlock.registerDispenseBehavior(Items.SHEARS.asItem(), new OptionalDispenseBehavior() {
         protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            if (!world.isRemote()) {
               ...
               for(SheepEntity sheepentity : world.getEntitiesWithinAABB(SheepEntity.class, new AxisAlignedBB(blockpos))) {
                  if (sheepentity.isAlive() && !sheepentity.getSheared() && !sheepentity.isChild()) {
