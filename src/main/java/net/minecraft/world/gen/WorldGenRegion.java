...
public class WorldGenRegion implements IWorld {
   ...
   public boolean destroyBlock(BlockPos pos, boolean dropBlock) {
      ...
      if (blockstate.isAir()) {
         ...
         if (dropBlock) {
            TileEntity tileentity = blockstate.getBlock().hasTileEntity() ? this.getTileEntity(pos) : null;
   ...
   public TileEntity getTileEntity(BlockPos pos) {
      ...
      if (tileentity != null) {
         ...
         if (ichunk.getBlockState(pos).getBlock() instanceof ITileEntityProvider) {
   ...
   public boolean setBlockState(BlockPos pos, BlockState newState, int flags) {
      ...
      } else if (blockstate != null && blockstate.getBlock().hasTileEntity()) {
