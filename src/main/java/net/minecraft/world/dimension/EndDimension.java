...
public class EndDimension extends Dimension {
   ...
   public EndDimension(World worldIn, DimensionType typeIn) {
      ...
      CompoundNBT compoundnbt = worldIn.getWorldInfo().getDimensionData(DimensionType.THE_END);
      this.dragonFightManager = worldIn instanceof ServerWorld ? new DragonFightManager((ServerWorld)worldIn, compoundnbt.getCompound("DragonFight")) : null;
   }
