                     ...
                     if (k2 < i2) {
                        label123: {
                           ...
                           if (biome$spawnlistentry == null) {
                              biome$spawnlistentry = func_222264_a(chunkgenerator, p_222263_0_, p_222263_1_.rand, blockpos$mutableblockpos);
                              if (biome$spawnlistentry == null) {
                                 break label123;
                              }
                           ...
                           if (!entitytype.isSummonable() || !func_222261_a(chunkgenerator, p_222263_0_, biome$spawnlistentry, blockpos$mutableblockpos)) {
                              break label115;
                           }
                           ...
                           if (d0 > 16384.0D && mobentity.canDespawn(d0) || !mobentity.canSpawn(p_222263_1_, SpawnReason.NATURAL) || !mobentity.isNotColliding(p_222263_1_)) {
                              break label115;
                           }
