...
public class LootPool {
   ...
   public void func_216099_a(ValidationResults p_216099_1_, Function<ResourceLocation, LootTable> p_216099_2_, Set<ResourceLocation> p_216099_3_, LootParameterSet p_216099_4_) {
      for(int i = 0; i < this.conditions.length; ++i) {
         this.conditions[i].func_215856_a(p_216099_1_.descend(".condition[" + i + "]"), p_216099_2_, p_216099_3_, p_216099_4_);
      }
      ...
      for(int k = 0; k < this.lootEntries.length; ++k) {
         this.lootEntries[k].func_216142_a(p_216099_1_.descend(".entries[" + k + "]"), p_216099_2_, p_216099_3_, p_216099_4_);
      }
