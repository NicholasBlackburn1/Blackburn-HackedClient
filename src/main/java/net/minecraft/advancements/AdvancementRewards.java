...
public class AdvancementRewards {
   ...
   public void apply(ServerPlayerEntity player) {
      ...
      LootContext lootcontext = (new LootContext.Builder(player.getServerWorld())).withParameter(LootParameters.THIS_ENTITY, player).withParameter(LootParameters.POSITION, new BlockPos(player)).withRandom(player.getRNG()).build(LootParameterSets.ADVANCEMENT);
      boolean flag = false;
