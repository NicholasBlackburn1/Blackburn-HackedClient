...
public class FireworkStarItem extends Item {
   ...
   public static void func_195967_a(CompoundNBT p_195967_0_, List<ITextComponent> p_195967_1_) {
      FireworkRocketItem.Shape fireworkrocketitem$shape = FireworkRocketItem.Shape.func_196070_a(p_195967_0_.getByte("Type"));
      p_195967_1_.add((new TranslationTextComponent("item.minecraft.firework_star.shape." + fireworkrocketitem$shape.func_196068_b())).applyTextStyle(TextFormatting.GRAY));
