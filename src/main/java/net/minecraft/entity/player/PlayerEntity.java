...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public void updateRidden() {
      if (!this.world.isRemote && this.isSneaking() && this.isPassenger()) {
         ...
         if (this.getRidingEntity() instanceof PigEntity) {
            this.rotationPitch = f1;
            this.rotationYaw = f;
            this.renderYawOffset = ((PigEntity)this.getRidingEntity()).renderYawOffset;
         }
   ...
   public static Optional<Vec3d> func_213822_a(IWorldReader p_213822_0_, BlockPos p_213822_1_, boolean p_213822_2_) {
      ...
      if (!(block instanceof BedBlock)) {
         ...
         return BedBlock.func_220172_a(EntityType.PLAYER, p_213822_0_, p_213822_1_, 0);
      }
   }
