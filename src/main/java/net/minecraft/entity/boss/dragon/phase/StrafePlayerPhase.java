         ...
         if (this.attackTarget.getDistanceSq(this.dragon) < 4096.0D) {
            if (this.dragon.canEntityBeSeen(this.attackTarget)) {
               ...
               if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F) {
                  ...
                  double d6 = this.dragon.field_70986_h.posX - vec3d2.x * 1.0D;
                  double d7 = this.dragon.field_70986_h.posY + (double)(this.dragon.field_70986_h.getHeight() / 2.0F) + 0.5D;
                  double d8 = this.dragon.field_70986_h.posZ - vec3d2.z * 1.0D;
                  double d9 = this.attackTarget.posX - d6;
                  double d10 = this.attackTarget.posY + (double)(this.attackTarget.getHeight() / 2.0F) - (d7 + (double)(this.dragon.field_70986_h.getHeight() / 2.0F));
